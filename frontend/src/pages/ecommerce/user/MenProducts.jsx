...
import styles from "../../../styles/ecommerce/user/MenProducts.module.css";
...
// Men Assets
import football from '../../../assets/images/ecommerce/men/image-men-1.png';
import run from '../../../assets/images/ecommerce/men/image-run.png';
import easyComfort from '../../../assets/images/ecommerce/men/image-easy-comfort.png';
...
function EcommerceMenProducts() {
    const [currentSlide, setCurrentSlide] = useState(0);

    // Array untuk 3 Foto Besar Campaign Men (Sesuai Desain Baru)
    const menCampaigns = [
        { id: 1, title: "Asterism Football Presents", image: football },
        { id: 2, title: "Run Essential", image: run },
        { id: 3, title: "Easy Comfort", image: easyComfort }
    ];
        ...
        <main className={styles.wrapper}>
            ...
            <nav className={styles.categoryBar} aria-label="Product Categories">
                <ul className={styles.categoryList}>
                    ...
                    <Link to="/ecommerce/men" className={`${styles.categoryLink} ${styles.activeCategory}`}>Man</Link>
            ...
            <section className={styles.menSection}>
                <header className={styles.menHeader}>
                    <h1>Men</h1>
                    <nav className={styles.subCategoryNav} aria-label="Men Sub Categories">
                        <Link to="/ecommerce/men/dekker" className={styles.subCategoryLink}>Dekker</Link>
                        <Link to="/ecommerce/men/socks" className={styles.subCategoryLink}>Socks</Link>
                        <Link to="/ecommerce/men/jersey" className={styles.subCategoryLink}>Jersey</Link>
                        <Link to="/ecommerce/men/t-shirt" className={styles.subCategoryLink}>T-Shirt</Link>
                    </nav>
                </header>

                <div className={styles.campaignGrid}>
                    {menCampaigns.map((camp) => (
...
export default EcommerceMenProducts;